...
def apiDeteksi():
	...
	if request.method=='POST':
		...
		# Text Pre-Processing
		text_input = text_preprocessing_process(text_input,stop_word,porter)
		...
		if(hasil==0):
			hasil_prediksi = "Kalimat BUKAN TOXIC"
		elif (hasil==1):
			hasil_prediksi = "Kalimat TOXIC"
		else:
...
if __name__ == '__main__':
	...
	stop_word = stop_words.union(additional_sw)
